...
namespace Preiswattera_3000
{
    class Const
    {
        ...
        public const string gamePointsDiffHeader = "Diffp.";
        public const int gamePointsDiffHeaderLength = 6;
        public const string gamePointsTotalHeader = "Spielp.";
        public const int gamePointsTotalHeaderLength = 7;
        #endregion
